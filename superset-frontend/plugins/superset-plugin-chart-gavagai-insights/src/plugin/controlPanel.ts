...
const config: ControlPanelConfig = {
  ...
  controlPanelSections: [
    ...
    {
      label: t('Gavagai Insights controls'),
      expanded: true,
      controlSetRows: [
        [
          {
        ...
        [
          {
            ...
            config: {
              type: 'TextControl',
              default: 'Get insights generated by AI',
              renderTrigger: true,
              // ^ this makes it apply instantaneously, without triggering a "run query" button
              label: t('Description Text'),
              description: t('The text you want to see in the description'),
            },
          },
        ],
      ],
