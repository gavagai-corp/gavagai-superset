 ...
 * under the License.
 */
import { SupersetPluginChartGavagaiInsights } from '../src';
 ...
 */
describe('superset-plugin-chart-gavagai-insights', () => {
  it('exists', () => {
    expect(SupersetPluginChartGavagaiInsights).toBeDefined();
  });
});
